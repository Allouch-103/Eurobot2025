...
#ifndef SERVICE__SRV__DETAIL__NAVI_STM__FUNCTIONS_H_
#define SERVICE__SRV__DETAIL__NAVI_STM__FUNCTIONS_H_
...
/// Initialize srv/NaviStm message.
/**
...
/// Create srv/NaviStm message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service__srv__NaviStm_Request__init().
...
/// Destroy srv/NaviStm message.
/**
 * It calls
 * service__srv__NaviStm_Request__fini()
...
/// Check for srv/NaviStm message equality.
/**
...
/// Initialize array of srv/NaviStm messages.
/**
...
/// Finalize array of srv/NaviStm messages.
/**
 * It calls
 * service__srv__NaviStm_Request__fini()
...
/// Create array of srv/NaviStm messages.
/**
 * It allocates the memory for the array and calls
 * service__srv__NaviStm_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/NaviStm messages.
/**
 * It calls
 * service__srv__NaviStm_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/NaviStm message array equality.
/**
...
/// Copy an array of srv/NaviStm messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service__srv__NaviStm_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service
...
/**
 * It calls
 * service__srv__NaviStm_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_service
...
/**
 * It allocates the memory for the array and calls
 * service__srv__NaviStm_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service
...
/**
 * It calls
 * service__srv__NaviStm_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVICE__SRV__DETAIL__NAVI_STM__FUNCTIONS_H_
